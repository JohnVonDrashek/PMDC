...
| File | Description |
|------|-------------|
| `BattleEvent.cs` | Base event implementations: `BounceStatusEvent`, `PreserveTurnEvent`, `AddContextStateEvent`, `FoulPlayEvent`, `IgnoreStatsEvent`, `RestoreBellyEvent`, `ExitDungeonEvent` |

### Status Effects

| File | Description |
|------|-------------|
| `StatusBattleEvent.cs` | Status application events: `StatusBattleEvent`, `StatusStackBattleEvent`, `RemoveStatusBattleEvent`, `TransferStatusEvent`, `RestEvent` |
| `StatusStateBattleEvent.cs` | Status state manipulation events |

### Damage System

| File | Description |
|------|-------------|
| `DamageModBattleEvent.cs` | Damage multipliers: `MultiplyElementEvent`, `MultiplyCategoryEvent`, `WeatherDamageEvent`, `TypeMatchupEvent` |
| `DirectDamageBattleEvent.cs` | Direct damage calculation: `DamageFormulaEvent`, `OHKODamageEvent`, `FixedDamageEvent` |
| `BasePowerBattleEvent.cs` | Base power modifications |
| `HitRateBattleEvent.cs` | Accuracy/evasion modifiers |

### Healing & Recovery

| File | Description |
|------|-------------|
| `HealBattleEvent.cs` | HP recovery: `RestoreHPEvent`, `WeatherHPEvent`, `HPDrainEvent`, `ReviveAllEvent` |
| `HPModBattleEvent.cs` | HP modification events |
| `EndureBattleEvent.cs` | Survive-at-1-HP effects |

### Counter & Reflect

| File | Description |
|------|-------------|
| `CounterBattleEvent.cs` | Damage reflection: `ReflectAllEvent`, `CounterTypeEvent`, `CounterCategoryEvent` |
| `RecoilBattleEvent.cs` | Self-damage effects |

### Move Modification

| File | Description |
|------|-------------|
| `DataModBattleEvent.cs` | Move data modifications |
| `HitboxModBattleEvent.cs` | Hitbox/range modifications |
| `PPModBattleEvent.cs` | PP (Power Point) modifications |
| `ForcedMoveBattleEvent.cs` | Forced move execution |
| `ReplaceEffectBattleEvent.cs` | Effect replacement/swap |

### Item System

| File | Description |
|------|-------------|
| `ItemBattleEvent.cs` | Item usage events |
| `ItemMetaBattleEvent.cs` | Item metadata handling |
| `MapItemBattleEvent.cs` | Ground item interactions |

### Conditional & Utility

| File | Description |
|------|-------------|
| `ConditionalBattleEvent.cs` | Condition-based event triggers |
| `CancelBattleEvent.cs` | Move/action cancellation |
| `AdditionalEffectBattleEvent.cs` | Secondary effect chances |
| `UtilityBattleEvent.cs` | Miscellaneous utility events |

### Special Effects

| File | Description |
|------|-------------|
| `TransformBattleEvent.cs` | Transformation/form change effects |
| `DisplaceBattleEvent.cs` | Knockback/teleport effects |
| `InvokeBattleEvent.cs` | Invoke other moves/effects |
| `ShareBattleEvent.cs` | Effect sharing between characters |
| `BystanderBattleEvent.cs` | Effects on nearby characters |
| `RecruitmentBattleEvent.cs` | Pokemon recruitment mechanics |

### Map & System

| File | Description |
|------|-------------|
| `MapStatusBattleEvent.cs` | Map-wide status effects (weather, terrain) |
| `TileMetaBattleEvent.cs` | Tile interaction events |
| `ProgressionBattleEvent.cs` | Level/experience/evolution events |
| `SystemBattleEvent.cs` | Game system events |
